...
/**
 * A common interface for signable classes such as {@link SignedData SignedData}
 * and {@link SignedAndEnvelopedData SignedAndEnvelopedData}.
 * 
 * @author Markus Tak
 * @version "$Id: Signable.java,v 1.3 2002/08/28 21:40:35 jpeters Exp $"
 */
public interface Signable extends CertificateSource {
    /**
     * Adds the given {@link SignerInfo SignerInfo} to this instance. This
     * method should be used rarely. In general, the <code>Signer</code>
     * instances take care of adding <code>SignerInfo</code> instances.
     * Explicit adding of a <code>SignerInfo</code> is provided only in those
     * cases where fine control of the creation of signatures is required.
     * 
     * @param info
    ...
    /**
     * Retrieves the content of the<code>Signable</code>, consisting of the
     * ASN.1 type embedded in its <code>
     * ContentInfo</code> structure.
     * 
     * @return The contents octets.
     * @throws GeneralSecurityException
     *                 if a cipher operation fails (only if content is
     *                 encrypted).
     */
