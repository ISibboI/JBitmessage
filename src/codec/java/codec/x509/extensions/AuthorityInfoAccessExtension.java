...
public class AuthorityInfoAccessExtension extends X509Extension {
    public static final String EXTENSION_OID = "1.3.6.1.5.5.7.1.1";

    private ASN1Sequence accessDescriptionSyntax = new ASN1SequenceOf(
     ...
     */
    public void addAccessDescription(AccessDescription newAD) throws Exception {
	accessDescriptionSyntax.add(newAD);
	setValue(accessDescriptionSyntax);
    }
	...
	buf.append(offset + accessDescriptionSyntax.toString());
	buf.append(offset + "}\n");
	return buf.toString();
    }
