...
public class SubjectKeyIdentifierExtension extends X509Extension {
    ...
    protected static final String ID_CE_SUBJECT_KEY_IDENTIFIER_ = new String(
	    "2.5.29.14");
     ...
     * @throws IOException
     */
    public SubjectKeyIdentifierExtension(byte[] ext) throws ASN1Exception,
	    IOException {
	super(ext);
    }
	...
	StringBuffer buf = new StringBuffer(offset + "SubjectKeyIdentifier ["
		+ ID_CE_SUBJECT_KEY_IDENTIFIER_ + "] {");
