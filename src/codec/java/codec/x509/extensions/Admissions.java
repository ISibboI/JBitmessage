...
public class Admissions extends ASN1Sequence {

    /**
     * Sequence holding the ProfessionInfos, at least one up to many.
     */
    private ASN1Sequence professionInfos = new ASN1SequenceOf(
	    ProfessionInfo.class);

    /**
     * 2. AdmissionAuthority
     */
    private GeneralName admissionAuth = null;
    ...
    /**
     * Admissionauthority Tag
     */
    private static final int TAG_ADMMISSION_AUTH_ = 0;

    /**
     * Admissionauthority Tagged Type
     */
    private ASN1TaggedType admissionAuthTag;

    /**
     * NamingAuthority Tag
     */
    private static final int TAG_NAMING_AUTH_ = 1;
    ...
    /**
     * adds a ProfessionInfo on the Sequence of the ProfessionInfos. Use it only
     * if you want to add only ONE ProfessionInfo. else the structure will be
     * set multiple !!!
     */
    public void addProfessionInfo(ProfessionInfo pi) {
	this.professionInfos.add(pi);
	add(professionInfos);
    }
	...
	if (this.admissionAuth != null)
	    result = result + "AdmissionAuthority " + this.admissionAuth;
	if (this.namingAuth != null)
	    result = result + "\n" + "NamingAuthority " + this.namingAuth;
