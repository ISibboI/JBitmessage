...
public class GF2nPolynomial {
     ...
     *                 if <tt>this</tt> and <tt>b</tt> are not defined over
     *                 the same field.
     */
     ...
     * @throws DifferentFieldsException
     *                 if <tt>this</tt> and <tt>s</tt> are not defined over
     *                 the same field.
     */
     ...
     * @throws DifferentFieldsException
     *                 if <tt>this</tt>, <tt>b</tt> and <tt>g</tt> are
     ...
     * @throws DifferentFieldsException
     *                 if <tt>this</tt> and <tt>g</tt> are not defined over
     *                 the same field.
     */
