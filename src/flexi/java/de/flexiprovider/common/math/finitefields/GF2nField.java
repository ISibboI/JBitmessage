...
public abstract class GF2nField {
	...
	for (i = 0; i < mDegree; i++) {
	    ...
	    } catch (BitDoesNotExistException BDNEExc) {
		throw new BitDoesNotExistException(i);
	    }
	}
     ...
     *                 if <tt>elem</tt> cannot be converted according to
     *                 <tt>basis</tt>.
	...
	if (mDegree != basis.mDegree) {
	    throw new DifferentFieldsException("GF2nField.convert: B1 has a"
