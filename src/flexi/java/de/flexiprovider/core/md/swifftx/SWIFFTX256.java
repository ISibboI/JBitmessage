...
/**
 * 
 * This class implements the SWIFFTX256 hash function. It is designed by Yuriy
 ...
 * 
 */
public class SWIFFTX256 extends MessageDigest {

	/**
	 * The algorithm name.
	 */
	public static final String ALG_NAME = "SWIFFTX256";
	...
	public synchronized void update(byte[] input, int offset, int len) {
		hashValue = SWIFFTX.hash(256, input, input.length * 8);
	}
