...
/**
 * 
 * This class implements the SWIFFTX384 hash function. It is designed by Yuriy
 ...
 * 
 */
public class SWIFFTX384 extends MessageDigest {

	/**
	 * The algorithm name.
	 */
	public static final String ALG_NAME = "SWIFFTX384";

	private int[] hashValue = new int[64];

	private int DIGEST_LENGTH = 48;
	...
	public synchronized void update(byte[] input, int offset, int len) {
		hashValue = SWIFFTX.hash(384, input, input.length * 8);
	}
