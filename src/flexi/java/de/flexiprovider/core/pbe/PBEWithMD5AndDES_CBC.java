 ...
 * {@link de.flexiprovider.core.md.MD5 MD5}) several times on it. Because we
 ...
 */
public class PBEWithMD5AndDES_CBC extends PBES1 {

    /**
     * The OID of PBEWithMD5AndDES_CBC.
     */
    public static final String OID = "1.2.840.113549.1.5.3";
	...
	// convert the DESede key spec into a DESKey
	SecretKey desKey;
	try {
	    desKey = desKeyFactory.generateSecret(desKeySpec);
	} catch (InvalidKeySpecException ikse) {
