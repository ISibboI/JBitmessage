 ...
 * {@link IQDSAParameterGenerator}. The parameters consist of the bit length of
 * the discriminant.
 * 
 * @author Martin Döring
 */
public class IQDSAParamGenParameterSpec implements AlgorithmParameterSpec {
    ...
    /**
     * Construct the default IQDSA parameter generation parameters. Choose the
    ...
    /**
     * Construct new IQDSA parameter generation parameters from the desired bit
